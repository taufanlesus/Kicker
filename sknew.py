...
cl = LineClient(authToken="EF0sXp8qMn1A0Z1lBAv2.jxl1SN5C0VBCdf3KY0ALSG.Ydrm+MRJrydESZj7dEnPwnYkzuvgrREEFHJpH6vUSk8=")
cl.log("Auth Token : " + str(cl.authToken))
ki = LineClient(authToken="EF0fkmD7qXPcqHgUmtM8.hpXfRo9zsECROspnskCnEa.zZQGW/aM2WQBVvrBLSdoDGk9xxBieCXZaArlD9q3MDs=")
...
kc = LineClient(authToken="EFRWSPpNoh6KAgPMV40e.mxRT8/wyrXqoSqIxpPxflG.Vy1zn84OafRnhO4/RMhiQPlqtgflqBJlMzTcBde8nx0=")
kc.log("Auth Token : " + str(kc.authToken))
kb = LineClient(authToken="EFItFqY2VbNCxH8gt9l3.EoaPWS1gPExU0k8NZsrMaW.dbAkoloXGI4pKSBQKjlPSfUf6HK+8mATc7rSrH8wFzs=")
kb.log("Auth Token : " + str(kb.authToken))
sw = LineClient(authToken="EFy7PAQE8Z5nN1qcYjd8.C/mfvbhTqhh5+/AEATGLEa.o4uN1XHrGKSUXLNpzioKEqu5KRZjdzC74EpgUXRioQk=")
sw.log("Auth Token : " + str(sw.authToken))

#===============================================================================================
poll = LinePoll(cl)
call = cl
creator = ["u1cfc45acef5949e72ba123cd48a70d78","ufdc20b3a00b5e8f31e4f91017eb361b0"]
owner = ["u1cfc45acef5949e72ba123cd48a70d78","ufdc20b3a00b5e8f31e4f91017eb361b0"]
admin = ["u1cfc45acef5949e72ba123cd48a70d78","ufdc20b3a00b5e8f31e4f91017eb361b0"]
staff = ["u1cfc45acef5949e72ba123cd48a70d78","ufdc20b3a00b5e8f31e4f91017eb361b0"]
