...
cl = LineClient(authToken="EFu467ikYaPZPV5iVrN1.CVLbVy/Zb0ltNJzSW1tOeq.vG5saISO7fs8t31aRAgdPRjMw0N5H37wPh0XkNuXLHQ=")
cl.log("Auth Token : " + str(cl.authToken))
ki = LineClient(authToken="EFRWSPpNoh6KAgPMV40e.mxRT8/wyrXqoSqIxpPxflG.Vy1zn84OafRnhO4/RMhiQPlqtgflqBJlMzTcBde8nx0=")
ki.log("Auth Token : " + str(ki.authToken))
kk = LineClient(authToken="EF5XOsEwbNQtrInr82Me.ZWWL7zpC2yHsErOmLcanBG.QAOynuEmhrgvJyfkp/P2tePUSU0bgamnDsrUk7oRL6M=")
kk.log("Auth Token : " + str(kk.authToken))
kc = LineClient(authToken="EFy7PAQE8Z5nN1qcYjd8.C/mfvbhTqhh5+/AEATGLEa.o4uN1XHrGKSUXLNpzioKEqu5KRZjdzC74EpgUXRioQk=")
kc.log("Auth Token : " + str(kc.authToken))
kb = LineClient(authToken="EF0fkmD7qXPcqHgUmtM8.hpXfRo9zsECROspnskCnEa.zZQGW/aM2WQBVvrBLSdoDGk9xxBieCXZaArlD9q3MDs=")
kb.log("Auth Token : " + str(kb.authToken))
sw = LineClient(authToken="EFISoduEHF0UOVlQtEj8.fEFUQGXJbnPpIc1XVulNga.d5ZhsHzViexRGEodIM1wkwjHqQd30L1B1jsTneo6pdY=")
sw.log("Auth Token : " + str(sw.authToken))

#===============================================================================================
poll = LinePoll(cl)
call = cl
creator = ["u72f941bd8fb30742d39e366cc354e811","u1cfc45acef5949e72ba123cd48a70d78"]
owner = ["u72f941bd8fb30742d39e366cc354e811","u1cfc45acef5949e72ba123cd48a70d78"]
admin = ["u72f941bd8fb30742d39e366cc354e811","u1cfc45acef5949e72ba123cd48a70d78"]
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            cl.sendMessage(msg.to, "Silahkan kirimkan video yang ingin anda jadikan profile")
                          ...
                          if msg._from in admin:
                           ...
                           if msg._from in admin:
                            ...
                            try:                    
                                ...
                                cl.sendImageWithURL(to, str(data["gambar"]))
                                cl.sendMessage(to, str(hasil))
                                cl.sendMessage(to, "Downloading...")
                                cl.sendMessage(to, "「 Result MP3 」")
                                cl.sendAudioWithURL(to, str(audio["mp3"]))
                                cl.sendMessage(to, "「 Result M4A 」")
                                cl.sendVideoWithURL(to, str(audio["m4a"]))
                                cl.sendMessage(to, "Success Download...")
                            except Exception as error:
...
#===========COMMAND BLACKLIST============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              k.sendMessage(msg.to,"Sukses membersihkan " +mc)
#===========COMMAND SET============#
